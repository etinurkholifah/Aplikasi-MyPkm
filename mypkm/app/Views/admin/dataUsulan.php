                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-6 text-end">
                            <a href="/admin/usulan/add" class="btn btn-primary">Tambah Data</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <a class="btn btn-primary btn-sm" href="/admin/usulan/update/<?= $row['id_usulan'] ?>">Update</a>
                                                <a class="btn btn-warning btn-sm" href="/admin/usulan/detail/<?= $row['id_usulan'] ?>">Detail</a>
                                            </div>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
...
<script>
    function confirmDelete(usulanId) {
        if (confirm("Apakah Anda yakin ingin menghapus mahasiswa dengan ID ")) {
            window.location.href = "/admin/usulan/delete/" + usulanId;
        }
    }
</script>
