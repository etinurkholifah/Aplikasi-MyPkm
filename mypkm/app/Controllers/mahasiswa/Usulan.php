...
class Usulan extends BaseController
{
    ...
    public function index()
    {
        ...
        $data = [
            'dataUsulan' => $this->usulan->getDataJoinMahasiswa(),
            'page_title' => "Usulan"
        ];

        return view('mahasiswa/dataUsulan', $data);
    }
    ...
    public function add()
    {
        ...
        return view('mahasiswa/usulanAdd', $data);
    }
    ...
    public function addProses()
    {
        ...
        try {
            ...
            return redirect()->to('mahasiswa/usulan')->with('success','Data berhasil ditambah');
        } catch (\Exception $e) {
            log_message('error', 'Terjadi kesalahan saat menambahkan data: ' . $e->getMessage());

            return redirect()->to('mahasiswa/usulan')->with('error','Gagal Menambah data');
        }
    }
    ...
    public function update($id)
    {
        ...
        return view('mahasiswa/usulanUpdate', $data);
    }
    ...
    public function UpdateProses()
    {
        ...
        try {
            ...
            return redirect()->to('mahasiswa/usulan')->with('success','Data berhasil diperbarui');
        } catch (\Exception $e) {
            log_message('error', 'Terjadi kesalahan saat memperbarui data: ' . $e->getMessage());

            return redirect()->to('mahasiswa/usulan')->with('error','Data gagal di perbarui');
        }
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->to('mahasiswa/usulan')->with('success','Data berhasil dihapus');
    }
    ...
    public function detail($id)
    {
        ...
        return view('mahasiswa/usulanDetail', $data);
    }
