...
<section>
    <div class="container">
        <div class="card card-body">
            <form id="form-submit" method="POST" action="<?= base_url('upload/save') ?>" enctype="multipart/form-data">
                <div class="form-group">
                    <label>ID Belmawa</label>
                    <input type="text" required name="id_belmawa" class="form-control" id="id_belmawa" placeholder="Id Belmawa">
                </div>
                <div class="form-group">
